...
class CuidadorPaseadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuidador_paseador" do
    assert_difference("CuidadorPaseador.count") do
      post cuidador_paseadors_url, params: { cuidador_paseador: { apellido: @cuidador_paseador.apellido, email: @cuidador_paseador.email, foto: @cuidador_paseador.foto, horarios: @cuidador_paseador.horarios, nombre: @cuidador_paseador.nombre, rol: @cuidador_paseador.rol, telefono: @cuidador_paseador.telefono } }
    end
  ...
  test "should update cuidador_paseador" do
    patch cuidador_paseador_url(@cuidador_paseador), params: { cuidador_paseador: { apellido: @cuidador_paseador.apellido, email: @cuidador_paseador.email, foto: @cuidador_paseador.foto, horarios: @cuidador_paseador.horarios, nombre: @cuidador_paseador.nombre, rol: @cuidador_paseador.rol, telefono: @cuidador_paseador.telefono } }
